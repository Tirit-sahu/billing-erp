...
class PaymentController extends Controller
{
    ...
    public function customerPayment()
    {
       ...
       $receiptSn = isset($reNo->receiptSn) ? $reNo->receiptSn +1 : 1;
        ...
        return view('customerPayment.customerPayment',compact('parties','NoReceipt','receiptSn'));
    ...
    {   
       ...
       if($data->type=='2'){
       $parties = party::where('supplier',1)->get();
        return view('supplierPayment.supplierPayment',compact('parties','data'));
       }

       if($data->type=='1'){
        $parties = party::where('customer',1)->get();
        return view('customerPayment.customerPayment',compact('parties','data'));
        }
