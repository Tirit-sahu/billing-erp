...
<div class="page-content">
    ...
    <div class="page-title">
        <h5><i class="fa fa-align-justify"></i> Add Head</h5>
    </div>
    <!-- /page title -->
    ...
    <!-- Advanced form components -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h6 class="panel-title">Add Head</h6></div>
            <div class="panel-body">
            <x-alert />
            @if(isset($data))

            <form action="{{ route('head.update',$data->id ) }}" class="form-horizontal" method="post" >
            @method('PATCH');

            @else
            <form action="{{ route('head.store') }}" class="form-horizontal" method="post" >
            @endif
                @csrf
