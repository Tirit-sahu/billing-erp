...
<div class="page-content">
    ...
    <div class="page-title">
        <h5><i class="fa fa-align-justify"></i> Add Supplier Payment</h5>
    </div>
    <!-- /page title -->
    ...
    <!-- Advanced form components -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h6 class="panel-title">Add Supplier Payment</h6></div>
            ...
            @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                            <select data-placeholder="Choose a Supplier Name..." class="select-search" name="party_id" id="party_id" required tabindex="2">
                                <option value=""></option> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input class="form-control" type="hidden" name="type" value="{{ old('type',isset($data->type) ? $data->type : '2' ) }}">
                    </div>
                </div>
                ...
                <div class="form-actions pull-right">
                    <a href="{{ route('supplierPayment.index') }}" class="btn btn-danger">Back </a>
