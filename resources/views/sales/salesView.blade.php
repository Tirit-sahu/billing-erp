...
<div class="page-content">
    ...
    <ul class="row stats">
        ...
        <li class="col-xs-3">
            <a href="{{ route('sales.create') }}" class="btn btn-info">Sales Entry</a>
        </li>
    </ul>
    <!-- /statistics -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{url('sale-details')}}?sale_id={{$row->id}}" class="btn btn-default btn-icon btn-xs tip" rel="tooltip" title="View">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                            </a>

                            <a href="{{url('sale-edit/'.$row->id)}}" class="btn btn-default btn-icon btn-xs tip" rel="tooltip" title="Edit">
