...
<link href="{{ asset('public/cdn/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="logo"><a href="index-2.html" title=""><h2>Mohan Enterprises</h2></a></div>
            <ul class="middle-nav">
        ...
        <div class="sidebar collapse">
        	<ul class="navigation">
               ...
               <li>
                ...
                <li>
                    <a href="{{ route('purchase.index') }}"><i class="fa fa-align-justify"></i> Purchase</a>
                </li>

                <li>
                    <a href="{{ route('sales.index') }}"><i class="fa fa-align-justify"></i> Sales</a>
                </li>
                <li>
